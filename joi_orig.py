...
VOICE = ""
# Valid values are: ZONOS, KOKORO, ELEVENLABS, PLAYHT, GVOICE, AZURE, AMAZON
...
GREETING_PROMPT = "Describe in detail what you would look like if you were human."
...
class TextToSpeechService:
    ...
    def synthesize_zonos(
        self,
        full_text: str,
        speaker_wav_path: str = "devito.mp3",
        prefix_wav_path: str = None,
        **kwargs
    ) -> bytes:
        """
